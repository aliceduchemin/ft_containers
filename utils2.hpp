		...
		public:
			...
			*/
			...
			void				resetNode()
			{
				...
				std::cout<<"reset node call smallest\n";
				...
				std::cout<<"reset node call biggest\n";
			...
			void remove(const key_type& k)
			{
				...
				if (((curr->left == NULL || curr->left == this->_rendNode) && (curr->right != NULL && curr->right != this->_lastNode)) ||
					((curr->left != NULL && curr->left != this->_rendNode) && (curr->right == NULL || curr->right == this->_lastNode)))
			...
			//		(curr->left != NULL && (curr->right == NULL || curr->right == this->_lastNode)))
				...
				else if ((curr->left == NULL || curr->left == this->_rendNode)
					&& (curr->right == NULL || curr->right == this->_lastNode))
				{
				...
				else if (curr->left == this->_rendNode)
				{
					std::cout<< "free 10: "<< curr->data.first<<std::endl;
				/*	if (curr == this->_root)
					{
						std::cout<<"is root\n";
						delete curr;
					...
					std::cout<< "curr parent = " << curr->parent->data.first<<std::endl;
					curr->left->parent = curr->parent;
					delete curr;
					std::cout<< "after delete curr\n";*/
				}
				this->_number--;
				...
				{
					this->_root = this->_smallestNode;
					this->_smallestNode->left = this->_rendNode;
					this->_root = this->_biggestNode;
					this->_biggestNode->right = this->_lastNode;
					std::cout<<"rend = " << this->_rendNode->data.first<<std::endl;
					std::cout<<"last = " << this->_lastNode->data.first<<std::endl;
				}
